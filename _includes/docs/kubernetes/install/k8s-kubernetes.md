...
![登录](md\kubernetes\dashboard-login.png)

Dashboard

![dashboard首页](md\kubernetes\dashboard-first.png)
...
![chrome设置](md\kubernetes\chrome.png)
